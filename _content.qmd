...
## Post-Workshop: Feedback on Workshop

```{=html}
<iframe width="100%" height="100%" src="https://stata-translations.github.io/workshop-results/post_workshop_useful.html" title="Responses to questions on the usefulness of the workshop. Most respondents found the workshop useful and are likely to use the resources for code translation."></iframe>
```
## Summary
...
## With Thanks to:
  ...
  James Carpenter, Tra My Pham, Asif Tamuri, David Perez-Suarez, David Fisher, Matteo Quartagno, Carlos Diaz Montana, Ian White, Toby Thompson

  **Links:**

  "Code Translation using Large Language Models: What's the role of the Research Software Engineer?" Presented at RSECon26, September 2026 [https://doi.org/10.5281/zenodo.22124100](https://doi.org/10.5281/zenodo.22124100)

  "Using Large Language Models and Coding Agents to Translate Stata Packages: Benefits and Risks." Presented at Stata Conference UK, September 2026 [https://doi.org/10.5281/zenodo.22124100](https://doi.org/10.5281/zenodo.22124100)
...
![](images/qr-code.png){fig-alt="Link to https://stata-translations.github.io/talks-isd/" height="240"}
